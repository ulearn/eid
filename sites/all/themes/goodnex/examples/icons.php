<h4 class="content-title wrap">Big Icons</h4>
...
<div class="four columns">
	...
	<ul class="unstyled-list">
		...
		<li>
			<i class="icons-monitor"></i>
			<a href="#">Monitor</a>	
		</li>
		<li>
			<i class="icons-magnifying"></i>
			<a href="#">Magnirying Glass</a>	
		</li>
		<li>
...
<div class="four columns">
	...
	<ul class="unstyled-list">
		...
		<li>
			<i class="icons-graph-up"></i>
			<a href="#">Graph Up</a>	
		</li>
		<li>
			<i class="icons-pie-chart"></i>
			<a href="#">Pie Chart</a>	
		</li>
		<li>
			<i class="icons-bar-chart"></i>
			<a href="#">Bar Chart</a>	
		</li>
		<li>
			<i class="icons-disc-graph"></i>
			<a href="#">Disc Graph</a>	
		</li>
		<li>
			<i class="icons-screwdriver"></i>
			<a href="#">Screwdriver + Spanner</a>	
		</li>
		<li>
			<i class="icons-sun"></i>
			<a href="#">Sun</a>	
		...
		<li>
			<i class="icons-coffee-cup"></i>
			<a href="#">Coffee Cup</a>	
		</li>
		<li>
			<i class="icons-shamrock"></i>
			<a href="#">Shamrock</a>	
		</li>
		<li>
...
<div class="four columns">
	...
	<ul class="unstyled-list">
		...
		<li>
			<i class="icons-puzzle"></i>
			<a href="#">Puzzle</a>	
		</li>
		<li>
			<i class="icons-umbrella"></i>
			<a href="#">Umbrella</a>	
		</li>
		<li>
			<i class="icons-bomb"></i>
			<a href="#">Bomb</a>	
		</li>
		<li>
			<i class="icons-speech-bubble"></i>
			<a href="#">Speech Bubble</a>	
		</li>
		<li>
		...
		<li>
			<i class="icons-alarm-clock"></i>
			<a href="#">Alarm Clock</a>	
		</li>
		<li>
			<i class="icons-thumbs-up"></i>
			<a href="#">Thumbs Up</a>	
		</li>
		<li>
			<i class="icons-thumbs-down"></i>
			<a href="#">Thumbs Down</a>	
		</li>
		<li>
			<i class="icons-tick-circle"></i>
			<a href="#">Tick Circle</a>	
		</li>
		<li>
			<i class="icons-cross-circle"></i>
			<a href="#">Cross Circle</a>	
		</li>
		<li>
...
<div class="four columns">
	...
	<ul class="unstyled-list">
		...
		<li>
			<i class="icons-wallet"></i>
			<a href="#">Wallet</a>	
		</li>
		<li>
			<i class="icons-tick"></i>
			<a href="#">Tick</a>	
		</li>
		<li>
			<i class="icons-paint-brush"></i>
			<a href="#">Paint Brush</a>	
		</li>
		<li>
			<i class="icons-network"></i>
			<a href="#">Social Network</a>	
		</li>
		<li>
			<i class="icons-layout"></i>
			<a href="#">Layout</a>	
		</li>
		<li>
			<i class="icons-megaphone"></i>
			<a href="#">MegaPhone</a>	
		</li>
		<li>
...
<h4 class="content-title">New Icons</h4>
...
<h4 class="content-title">Web Application Icons</h4>
...
<h4 class="content-title">Text Editor Icons</h4>
...
<h4 class="content-title">Directional Icons</h4>
...
<h4 class="content-title">Video Player Icons</h4>
...
<h4 class="content-title">Social Icons</h4>
...
<h4 class="content-title">Medical Icons</h4>
